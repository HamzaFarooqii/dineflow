...
try {
  ...
  await expect(ownerPage.getByRole('heading', { name: 'Guests' })).toBeVisible()
  await ownerPage.getByLabel('Guest name').fill('Fixture owner customer')
  ...
  await expect(ownerPage.getByText('Guest saved on this browser.', { exact: false })).toBeVisible()
  ...
  await expect(cashierPage.getByRole('heading', { name: 'Guests' })).toBeVisible()
  ...
  await cashierPage.getByLabel('Guest name').fill('Fixture offline customer')
