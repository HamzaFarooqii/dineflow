...
const nav = [['⌂', 'Dashboard', '/dashboard'], ['⌁', 'Sell', '/register'], ['▦', 'Menu', '/products'], ['▤', 'Orders', '/orders'], ['♧', 'Guests', '/customers'], ['▥', 'Reports', '/reports'], ['⚙', 'Settings', '/settings'], ['◫', 'Floor & Tables', '/floor'], ['♨', 'Kitchen', '/kitchen']] as const
